...
export const metadata: Metadata = {
  title: 'Ram Sarraf | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Ram Sarraf! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
