        ...
        <div className="container flex flex-col items-start justify-center tracking-wide text-black dark:text-white">
          <div className="container relative flex h-full w-full flex-col items-center">
            <div className="h-72 w-[280px] text-center text-[2rem] font-extrabold sm:w-[520px] md:w-[700px] lg:mb-5 lg:w-[920px] lg:text-[3rem]">
              ...
              <br />
              <TextAnimation delay={1} baseText={`I'm Ram!`} />
            </div>
            <motion.div
            ...
            >
              ...
              <a
                ...
                href="https://drive.google.com/file/d/19tvzOVXMWmKbj9u42K0ppCo_6wQGwyGG/view?usp=drive_link"
                download
                target="_blank"
              >
              ...
              <div className="flex gap-2">
                <a
                  ...
                  href="https://www.linkedin.com/in/ram-sarraf-049972200/"
                  target="_blank"
                >
                  <Linkedin />
                </a>
                <a
                  ...
                  href="https://github.com/ramsarraf11"
                  target="_blank"
                >
                  <Image
                    width={25}
